  ...
  return (
    <div style={{ backgroundColor: `${navBg}` }} className="fixed w-full h-20 shadow-xl z-[100]">
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Link href="/">
          <div>
            <h2 className="text-[#5651e5] cursor-pointer">Portfolio</h2>
          </div>
        </Link>
        <div>
...

{
  /* <div
        className={
          navmenu ? " md:hidden fixed left-0 top-0 w-full h-screen bg-black/60" : ""
        }
      >
        <div
          className={
          ...
          <div>
            ...
            <div className="border-b border-gray-300 my-4">
              <p className="w-[85%] md:w-[90%] py-4">
                Let's build somehting interesting together!!
              </p>
            </div>
          </div>
